...
<Card title="Style Your Docs" icon="paintbrush" href="https://www.mintlify.com/docs/organize/settings">
...
<Card
  ...
  icon="square-code"
  href="https://www.mintlify.com/docs/api-playground/mdx/configuration"
>
...
<Card
  ...
  icon="browser"
  href="https://www.mintlify.com/docs/settings/custom-domain"
>
