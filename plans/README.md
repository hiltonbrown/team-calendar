...
|------|-------|----------|--------|------------|--------|
| 001 | Stripe webhook: fail loudly, drop placeholder org id, add tests | P1 | M | none | DONE (verified 2026-07-11 at `e3423da`) |
...
| 019 | Harden the Xero token refresh strategy (classify errors, mark stale, lock manual path) | P1 | M | none | DONE (executed and reviewed 2026-07-12 at `9c17067`, based on plan 018 `11cd418`) |
